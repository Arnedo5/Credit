            ...
            <div class="col s12 m4 l6 offset-l3">
                <div class="card">
                    <div class="card-content">
                        <form enctype="multipart/form-data"  method="POST" action="{{ route('user_edit.update', $user->USRID) }}">
                            {{ csrf_field() }}
                            ...
                            <div class="first-step transform">
                                ...
                                <div class="row">
                                    <div class="input-field col s6 m6 l6">
                                        <p class="margin right-align medium-small left"><a href="{{route('user-home')}}">Panell d'usuari</a></p>
                                    </div>
                                    <div class="input-field col s6 m6 l6">
