...
<ul id="slide-out" class="side-nav fixed">
    ...
    @endif
    <li><p class="tittle-categories">PANELL D'USUARI</p></li>
    <div class="divider-mini"></div>
        <li><a href="{{route('product.index')}}"><i class="material-icons">shopping_basket</i>Compres</a></li>
        <li><a href="{{route('home')}}"><i class="material-icons">question_answer</i>Tickets</a></li>
        <li><a href="{{route('home')}}"><i class="material-icons">receipt</i>Tickets de reparació</a></li>
        <li><a href="{{route('home')}}"><i class="material-icons">perm_identity</i>Modificar perfil</a></li>
    <div class="divider-mini"></div>
</ul>
